...
<li><a href="#">SCHEDULE</a>
    ...
    <li><a href="#">PASSENGER</a>
        <ul class="sub-menu">
            <li><a herf="">PASSENGER DETAILS</a></li>
...
<center><s:form name="viewrouteform" action="viewroutebyid" method="post">
<s:textfield name="routeid" label="Enter Route Id"></s:textfield>
<s:submit value="View By Id"> </s:submit>
</s:form><br>
<hr>
<s:form name="viewrouteform1" action="viewallroute" method="post">
<s:submit value="View All Routes"> </s:submit>
</s:form>
	</div>
