...
<tr ><th align="center" colspan="5"><h4><font >ALL FLIGHT DETAILS</font></h4></th></tr>

<tr ><td><h4><font >Flight ID</font></h4><td><h4><font >Flight Name</font></h4></td>
<td><h4><font >Seating Capacity</font></h4></td><td><h4><font >Reservation Capacity</font></h4></td>
<td><h4><font >OPERATIONS</font></h4></td><td></td></tr>
<s:iterator value="flightList">
	...
	<td><s:form name="editform" action="editflights" method="post">
		<s:submit value="Edit"></s:submit>
		<s:hidden value="%{flightid}" name="flightid"></s:hidden>
		</s:form>
	</td>
<td>
	<s:form name="deleteform" action="deleteflights" method="post">
		<s:submit value="Delete"></s:submit>
		<s:hidden value="%{flightid}" name="abc"></s:hidden>
