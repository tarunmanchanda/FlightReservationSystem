...
<center><s:form name="viewform2" action="viewschedulebyid" method="post">
<s:textfield name="scheduleid" label="Enter Schedule Id"></s:textfield>
<s:submit value="View By Id"> </s:submit>
</s:form><br>
<hr>
<s:form name="viewform3" action="viewallschedule" method="post">
<s:submit value="View All Schedule"> </s:submit>
</s:form></center>
	</div>
