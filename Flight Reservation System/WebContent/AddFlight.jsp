...
<br>
<br>
 <center><s:form name="addflight" action="addflight" method="post">
<s:textfield name="flightname" label="Flight name"></s:textfield>
<s:textfield name="seatingcapacity" label="Seating Capacity"></s:textfield>
<s:textfield name="reservationcapacity" label="Reservation Capacity"></s:textfield>
