...
<CENTER><s:form name="addroute" action="addroute" method="post">
<s:textfield name="source" label="Source"></s:textfield>
<s:textfield name="destination" label="Destination "></s:textfield>
<s:textfield name="distance" label="Distance "></s:textfield>
<s:textfield name="fare" label="Fare "></s:textfield>
